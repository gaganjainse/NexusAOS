...
INDEX_FILE = os.path.join(BASE_DIR, "core", "exports", "Sesha_file_index.json")
...
def build_index():
    """Recursively scans the Sesha_corporate_os directory and builds a JSON index."""
    index = []
    print(f"Indexing SeshaAOS at: {BASE_DIR}...")
