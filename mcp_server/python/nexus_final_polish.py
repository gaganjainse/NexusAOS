...
SUPERIORS = {
    ...
    "Sovereign Proxy (Nexus Omni-Lead)": "THE SOVEREIGN",
    "Nexus Orchestrator Agent": "Sovereign Proxy (Nexus Omni-Lead)",
    "Nexus Input Parser Agent": "Nexus Orchestrator Agent",
    "Oracle Interface Agent (OIA)": "Nexus Orchestrator Agent",
    "Learning Synthesis Agent": "Sovereign Proxy (Nexus Omni-Lead)",
    "System Health Supervisor": "Sovereign Proxy (Nexus Omni-Lead)",
    ...
    "Nexus Logic Engine": "Chief Agentic Officer (CAO)",
    ...
    for root, _, files in os.walk(str(ARCHIVE_DIR)):
        for file in files:
            if file.endswith(".md"):
                ...
                if title == "Sovereign Proxy (Nexus Omni-Lead)" or title == "Board of Directors":
