...
from tools.thought_agent import ThoughtAgent
...
class QueueManager:
    ...
    def defer_directive(self, text: str, priority: int = 5) -> str:
        """Buffers a directive into the Deferred queue."""
        ...
        return f"Directive [{directive_id}] buffered in Cognitive Buffer. I will execute it when conditions are optimal."
