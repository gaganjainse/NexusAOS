...
- **NEURAL 14.0 Update:** Battery is no longer a "Resource"; it is a **Somatic Buffer**. The Sesha Mind manages the ion-flux rate to match the current cognitive load.
...
- **NEURAL 14.0 Update:** Total **Kinetic Optimality**. Movement = Energy. The more the Sovereign interacts, the longer the Sesha survives.
