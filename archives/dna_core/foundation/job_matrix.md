...
## Purpose
To ensure that every role has a clear supervisor, a defined purpose, and that there are no **"Unsupervised Nodes"** or **"Administrative Bloat"** within the organization.
...
**Navigation:** [Global Dashboard](./aos_handbook.md) | [Site Map](./site_map.md)
