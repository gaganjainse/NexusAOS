...
import { CoreWorkspaceState, VitalsData, MCPTool } from "../../types/Sesha";
import {
  Cpu,
  Zap,
  Activity,
...
interface SeshaCoreWorkspaceProps {
...
export const SeshaCoreWorkspace: React.FC<SeshaCoreWorkspaceProps> = ({
  coreState,
  vitals,
  tools,
  onToggleSubtask,
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-bold text-amber-300 text-sm tracking-wide">
              Sesha CORE: GARBHAGRIHA SANCTUM v13.0
            </span>
